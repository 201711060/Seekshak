    ...
    <body>
     ...
     <div class="col-md-6 account-left">
					...
					<div class="address">
						...
						<input type="text" name="institutecategory" title="only name" type="text" pattern="[a-zA-Z ]*$" required />
					</div>
					<div class="address">
						<span>Institute Website</span>
						<input type="text" name="institutewebsite" title="only name" type="text" pattern="[a-zA-Z ]*$" required />
					</div>
					<div class="address">
						<span>Affiliated University</span>
						<input type="text" name="affiliateduniversity" title="only name" type="text" pattern="[a-zA-Z ]*$" required />
					</div>
					<div class="address">
						<span>Ranking</span>
						<input type="text" name="ranking" title="only name" type="text" pattern="[a-zA-Z ]*$" required />
					</div>
					<div class="address">
					...
					<div class="address">
						...
						<input type="text" name="contactno" title="only name" type="text" pattern="[a-zA-Z ]*$" required />
					</div>
